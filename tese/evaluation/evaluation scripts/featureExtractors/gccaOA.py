...
def main(args):
    path_mfcc = "/afs/l2f/home/jar/Documents/tese/Tese/tese/evaluation/evaluation scripts/extractedFeatures/mffc/"
    path_chroma = "/afs/l2f/home/jar/Documents/tese/Tese/tese/evaluation/evaluation scripts/extractedFeatures/chroma/"
    path_cqt = "/afs/l2f/home/jar/Documents/tese/Tese/tese/evaluation/evaluation scripts/extractedFeatures/cqt/"
    paths = {"chroma": path_chroma, "mfcc": path_mfcc, "cqt": path_cqt}
    views = []
    ...
    for feature in args[2:]:
        for key in paths:
            if (feature == key):
                path = paths[feature]
                view = np.transpose(np.loadtxt(path, delimiter=','))
                views.append(view)
